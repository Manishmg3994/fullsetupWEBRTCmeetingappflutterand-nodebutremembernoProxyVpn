...
class _MeetingPageState extends State<MeetingPage> {
  ...
  void startMeeting() async {
    ...
    meetingHelper = WebRTCMeetingHelper(
      url:
          "http://10.0.2.2:5000", //"http://127.0.0.1:5000", // TODO change is requred everytime for new host for windowsuse 127 and for android use 10.0.2 ank make sure use ing proxy setup for android by uing emulator
